...
function onDeviceReady() {
    ...
    db.transaction(function(tx) {
        ...
        tx.executeSql('CREATE TABLE IF NOT EXISTS booking (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, customer_id INTEGER, schedule_id INTEGER, seat_id INTEGER, date_recorded DATETIME NOT NULL, date_updated DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (customer_id) REFERENCES customers(id), FOREIGN KEY (schedule_id) REFERENCES schedule(id), FOREIGN KEY (seat_id) REFERENCES seat(id)');
